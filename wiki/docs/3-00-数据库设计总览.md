...
| `schema/05_outputs.sql` | 结果与 Execution I/O | `study_outputs` · `dataset_file_derivations` · `pipeline_execution_inputs` · `pipeline_execution_dependencies` |
...
| 输出产物 | `study_outputs` | `05_outputs.sql` | [3-45](3-45-StudyOutput.md) |

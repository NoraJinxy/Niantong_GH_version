...
| `schema/05_outputs.sql` | 派生数据与 Execution I/O | `study_outputs` · `dataset_file_derivations` · `pipeline_execution_inputs` · `pipeline_execution_dependencies` |
...
| [3-45 StudyOutput](3-45-StudyOutput.md) | `study_outputs` 详细字段、生命周期、retention 策略 | 改派生数据登记、清理策略时 |

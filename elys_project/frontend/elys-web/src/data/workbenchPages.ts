...
export const topNavItems: WorkbenchNavItem[] = [
  ...
  { key: 'datasets', label: '数据集', to: '/datasets', icon: 'import', status: 'live' },
  { key: 'studies', label: '研究项', to: '/studies', icon: 'studies', status: 'live' },
  { key: 'analysis', label: '工作流', to: '/pipeline', icon: 'analysis', status: 'live' },
  { key: 'results', label: '派生数据', to: '/results', icon: 'analysis', status: 'live' },
  ...
  { key: 'ai', label: '机器学习', to: '/ml', icon: 'ai', status: 'preview' },
]
...
export const sideNavGroups: WorkbenchNavGroup[] = [
  {
    ...
    items: [
      ...
      { key: 'datasets', label: '数据集管理', to: '/datasets', icon: 'import', status: 'live' },
      { key: 'studies', label: '研究项', to: '/studies', icon: 'studies', status: 'live' },
      { key: 'pipeline', label: '工作流与运行记录', to: '/pipeline', icon: 'pipeline', status: 'live' },
    ],
  },
  {
    title: '预处理与分析预览',
    items: [
      ...
      { key: 'ml', label: '机器学习', to: '/ml', icon: 'ai', status: 'preview' },

...
describe('port type helpers', () => {
  ...
  it('liteGraphPortType maps wildcard to empty string', () => {
    ...
    expect(liteGraphPortType('epoch_source')).toBe('eeg_data,epochs')
  })
  it('portTypesCompatible', () => {
    ...
    expect(portTypesCompatible('eeg_data', 'epoch_source')).toBe(true)
    expect(portTypesCompatible('epochs', 'epoch_source')).toBe(true)

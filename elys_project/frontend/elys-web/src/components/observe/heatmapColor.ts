// 时频热图配色（TFR 专用）：
//  招牌：elys 风格发散色（默认，长在品牌 DNA 上、有辨识度）
...
// elys 招牌发散色（TFR 默认）：深靛蓝→主蓝→浅蓝→暖瓷白(0)→金→语义红→深酒红。
// 长在 elys 品牌 DNA 上（主蓝 #3F5E8F + 语义琥珀/红），深色端 + 暖白心 = 比 RdBu 更有辨识度的「招牌脸」。
const ELYS: Stops = [
  [-1.0, [26, 41, 72]], [-0.55, [63, 94, 143]], [-0.22, [142, 163, 198]],
  [0.0, [244, 241, 233]],
  [0.22, [223, 170, 95]], [0.58, [176, 84, 76]], [1.0, [115, 40, 40]],
]

...
#   ./deploy.sh --role entry --data-upstream http://REPLACE_WITH_COMPUTE_PUBLIC_IP
...
ENTRY_PUBLIC_IP="${ENTRY_PUBLIC_IP:-REPLACE_WITH_ENTRY_PUBLIC_IP}"
COMPUTE_PUBLIC_IP="${COMPUTE_PUBLIC_IP:-REPLACE_WITH_COMPUTE_PUBLIC_IP}"
ENTRY_ACCESS_HOST="${ENTRY_ACCESS_HOST:-REPLACE_WITH_ENTRY_ACCESS_HOST}"
DATA_ACCESS_HOST="${DATA_ACCESS_HOST:-REPLACE_WITH_DATA_ACCESS_HOST}"
...
TEST_USER_PASSWORD="${TEST_USER_PASSWORD:-CHANGE_ME_TEST_USER_PASSWORD}"
